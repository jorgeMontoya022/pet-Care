...
<main class="max-w-7xl mx-auto px-6 pt-24 pb-12">
    ...
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="${pageContext.request.contextPath}/WEB-INF/views/duenos/formRegistrar.jsp"
    ...
    <div class="bg-white border border-zinc-100 rounded-2xl overflow-hidden shadow-sm">
        <table class="w-full text-sm">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2">
                            <a href="${pageContext.request.contextPath}/duenos?accion=editar&cedula=${dueno.cedula}"
                               class="px-3 py-1.5 text-xs text-zinc-600 bg-zinc-100 rounded-lg hover:bg-zinc-200 transition-all">
                                Editar
                            </a>
                            <a href="${pageContext.request.contextPath}/duenos?accion=eliminar&cedula=${dueno.cedula}"
                               ...
                               class="px-3 py-1.5 text-xs text-red-500 bg-red-50 rounded-lg hover:bg-red-100 transition-all">
                                Eliminar
                            </a>
                        </div>
                    </td>
            ...
            <c:if test="${empty duenos}">
                <tr>
                    <td colspan="5" class="px-6 py-12 text-center text-zinc-300 text-sm">
